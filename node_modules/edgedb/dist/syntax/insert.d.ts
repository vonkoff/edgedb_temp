...
export declare type InsertShape<Root extends ObjectTypeSet> = $expr_PathNode extends Root ? never : typeutil.stripNever<stripNonInsertables<stripBacklinks<Root["__element__"]["__pointers__"]>>> extends infer Shape ? Shape extends ObjectTypePointers ? typeutil.addQuestionMarks<{
