...
exports.joinFrags = exports.frag = exports.getRef = exports.makeValidIdent = exports.getInternalName = exports.displayName = exports.capitalize = exports.toTSObjectType = exports.toTSScalarType = exports.literalToScalarMapping = exports.scalarToLiteralMapping = exports.quote = exports.toIdent = exports.splitName = void 0;
...
function toTSScalarType(type, types) {
    var _a, _b;
    switch (type.kind) {
        case "scalar": {
            ...
            if (type.material_id) {
                return toTSScalarType(types.get(type.material_id), types);
            }
        ...
        case "array": {
            const tn = toTSScalarType(types.get(type.array_element_id), types);
            return frag `${tn}[]`;
        }
        case "tuple": {
            ...
            if (type.tuple_elements[0].name &&
                ...
                for (const { name, target_id } of type.tuple_elements) {
                    const tn = toTSScalarType(types.get(target_id), types);
